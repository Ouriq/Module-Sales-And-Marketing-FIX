/* ===================================================================
   app.js – FoodSync Login (static / Vercel)
   =================================================================== */

const DASHBOARD_PAGE = 'dashboard.html';

const DEMO_USERS = [
  { email: 'admin@foodsync.com',  password: 'admin123', name: 'Administrator' },
  { email: 'user@foodsync.com',   password: 'user123',  name: 'User FoodSync' },
