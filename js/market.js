...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (btnShowAddForm) {
      btnShowAddForm.addEventListener('click', () => showView(marketAddFormView));
    }
    if (btnCancelAdd) {
      btnCancelAdd.addEventListener('click', () => showView(marketDashboardView));
    }
    if (btnSaveData) {
      btnSaveData.addEventListener('click', () => showView(marketSuccessView));
    }
    if (btnSuccessAddMore) {
      btnSuccessAddMore.addEventListener('click', () => showView(marketAddFormView));
    }
